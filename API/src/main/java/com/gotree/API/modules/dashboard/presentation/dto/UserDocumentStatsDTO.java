package com.gotree.API.modules.dashboard.presentation.dto;
...
public class UserDocumentStatsDTO {
    ...
    @Schema(description = "Total de horas em visitas")
    private long totalVisitTimeHours;

    @Schema(description = "Minutos restantes")
    ...
    public UserDocumentStatsDTO(Long userId, String userName) {
        ...
        this.totalVisitTimeHours = 0;
        this.totalVisitTimeMinutes = 0;
    }
}